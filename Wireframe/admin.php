...
<main>
    ...
    <div class="main-div">
        ...
        // listing is ordered by using surname
        ...
        // make sure the connection file is working and the SQL query is executed, if not show an error message
        ...
        if ($resultQuery === false) {
            ...
            // a table that displays the user details neatly
        ...
        <th class = 'columnTitle'> Category </th>
            ...
            // fetches the object by row and puts it neatly into the table
            // we use rowObj with field name such as ( forename, surname) to assign into the column declared above
        ...
        // close the query and close the connection after for security purposes
        $resultQuery->close();
        $dbConn->close();
        echo "</table>";
        ?>
